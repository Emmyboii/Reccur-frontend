...
const LiveRates = () => {
    ...
    return (
        <div className={`fixed top-0 h-screen bg-white lg:p-10 py-8 px-4 duration-700 text-black z-50 overflow-auto ${liveRatesBar ? 'sm:w-[40%] w-full right-0' : 'right-[-100%] w-[40%]'}`}>
