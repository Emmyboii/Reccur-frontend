...
const CreateAcctBar = () => {
    ...
    const handleChange = (selectedOption) => {
        ...
        if (selectedOption.value === 'usd') {
            ...
            setOutput("Your EUR account comes with a unique account number, making it easy to share with anyone sending you payments in USD. Enjoy seamless transactions without hidden fees or unfavorable exchange rates.");
        } else {
            setOutput("");
        }
    };
