...
const InvoiceSettings = (props) => {
    ...
    return (
        <div className={TransactionType === 'Invoice' ? 'flex flex-col gap-10 w-[848px]' : 'hidden'}>
            <div className='flex justify-between'>
                <div className='flex flex-col gap-1'>
                    <p className='text-[18px] font-medium text-[#1D1C1F]'>Invoice settings</p>
                    <p className='text-[14px] font-normal text-[#525154]'>Update your invoice preferences</p>
                </div>
